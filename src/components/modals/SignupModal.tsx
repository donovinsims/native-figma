...
export function SignupModal({ isOpen, onClose, onSwitchToLogin }: SignupModalProps) {
  ...
  const handleTwitterSignup = () => {
    toast.success("Twitter signup coming soon!");
  };
        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-2xl w-full max-w-[480px] overflow-hidden max-h-[90vh] overflow-y-auto"
            >
              <div className="relative p-8 md:p-10">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-500">
                    Join SEESAW to discover amazing apps
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 transition-colors"
                  >
                  ...
                  >
                    ...
                    <span className="text-gray-900">Continue with Twitter</span>
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 rounded-lg border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all"
                      />
                    </div>
                  </div>
                  ...
                  {/* Confirm Password */}
                  <div>
                    <label htmlFor="confirm-password" className="block text-sm text-gray-900 mb-2">
                      Confirm Password
                    </label>
                    <div className="relative">
                      <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
